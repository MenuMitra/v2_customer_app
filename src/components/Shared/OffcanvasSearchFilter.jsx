      ...
      <div className="filter-area">
        ...
        <div className="filter-content">
          <div className="title-bar mb-3">
            <h5 className="sub-title mb-0 text-lg font-semibold">Food Type</h5>
          </div>
          <div className="border-b border-[#F0F0F0] flex justify-between items-center pb-3">
            <ul className="flex items-center flex-wrap w-full list-none p-0 m-0">
          ...
          <div className="title-bar mt-4 mb-3">
            <h5 className="sub-title text-lg font-semibold">Price Range</h5>
          </div>
            ...
            <ul className="flex items-center flex-wrap list-none p-0 m-0">
              ...
              <li className="w-1/2 pb-2 pr-2">
                <div className="flex items-center">
                  ...
                  />
                  <label className="ml-2 text-sm cursor-pointer" htmlFor="flexCheckChecked2">
                    Voucher
                  </label>
                </div>
              </li>
              <li className="w-1/2 pb-2 pr-2">
                <div className="flex items-center">
                  ...
                  />
                  <label className="ml-2 text-sm cursor-pointer" htmlFor="flexCheckChecked3">
                    Free Shipping
                  </label>
                </div>
              </li>
              <li className="w-1/2 pb-2 pr-2">
                <div className="flex items-center">
                  ...
                  />
                  <label className="ml-2 text-sm cursor-pointer" htmlFor="flexCheckChecked4">
                    Same Day Deliv.
                  </label>
                </div>
              </li>
          ...
          <div className="title-bar mt-4 mb-3">
            <h5 className="sub-title text-lg font-semibold">Categories</h5>
          </div>
          <div className="pb-3">
            <ul className="list-none p-0 m-0">
              <li className="flex items-center pb-3">
                <svg className="mr-3" width="21" height="24" viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h6 className="sub-title mb-0 flex-1 font-bold text-base">Fresh Fruits</h6>
                <h6 className="sub-title text-[#9c9c9c] mb-0 ml-auto font-medium text-sm">4 Stars</h6>
              ...
              <li className="flex items-center pb-3">
                <svg className="mr-3" width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <h6 className="sub-title mb-0 flex-1 font-bold text-base">Fresh Vegetables</h6>
                <h6 className="sub-title text-[#9c9c9c] mb-0 ml-auto font-medium text-sm">68 Items</h6>
                <svg className="ml-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8.25005 20.25C8.05823 20.25 7.86623 20.1767 7.7198 20.0303C7.42673 19.7372 7.42673 19.2626 7.7198 18.9698L14.6895 12L7.7198 5.03026C7.42673 4.7372 7.42673 4.26263 7.7198 3.96976C8.01286 3.67688 8.48742 3.67669 8.7803 3.96976L16.2803 11.4698C16.5734 11.7628 16.5734 12.2374 16.2803 12.5303L8.7803 20.0303C8.63386 20.1767 8.44186 20.25 8.25005 20.25Z" fill="#7D8FAB"></path>
                </svg>
              </li>
              <li className="flex items-center pb-3">
                ...
                <h6 className="sub-title mb-0 flex-1 font-bold text-base">Mushrooms</h6>
                <h6 className="sub-title text-[#9c9c9c] mb-0 ml-auto font-medium text-sm">17 Items</h6>
                <svg className="ml-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8.25005 20.25C8.05823 20.25 7.86623 20.1767 7.7198 20.0303C7.42673 19.7372 7.42673 19.2626 7.7198 18.9698L14.6895 12L7.7198 5.03026C7.42673 4.7372 7.42673 4.26263 7.7198 3.96976C8.01286 3.67688 8.48742 3.67669 8.7803 3.96976L16.2803 11.4698C16.5734 11.7628 16.5734 12.2374 16.2803 12.5303L8.7803 20.0303C8.63386 20.1767 8.44186 20.25 8.25005 20.25Z" fill="#7D8FAB"></path>
                </svg>
              </li>
              <li className="flex items-center pb-3">
                ...
                <h6 className="sub-title mb-0 flex-1 font-bold text-base">Fresh Fishes</h6>
                <h6 className="sub-title text-[#9c9c9c] mb-0 ml-auto font-medium text-sm">36 Items</h6>
                <svg className="ml-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8.25005 20.25C8.05823 20.25 7.86623 20.1767 7.7198 20.0303C7.42673 19.7372 7.42673 19.2626 7.7198 18.9698L14.6895 12L7.7198 5.03026C7.42673 4.7372 7.42673 4.26263 7.7198 3.96976C8.01286 3.67688 8.48742 3.67669 8.7803 3.96976L16.2803 11.4698C16.5734 11.7628 16.5734 12.2374 16.2803 12.5303L8.7803 20.0303C8.63386 20.1767 8.44186 20.25 8.25005 20.25Z" fill="#7D8FAB"></path>
                </svg>
              </li>
